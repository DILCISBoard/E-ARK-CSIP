...
- [5. Use of metadata](metadata/)
	...
	- [5.3. Use of METS](metadata/#53-use-of-mets)
    - [5.3.1.	Use of the METS root element (element mets)](metadata/#531-use-of-the-mets-root-element-element-mets)
    - [5.3.2.	Use of the METS header (element metsHdr)](metadata/#532-use-of-the-mets-header-element-metshdr)
    - [5.3.3 Use of the METS descriptive metadata section (element dmdSec)](metadata/#533-use-of-the-mets-descriptive-metadata-section-element-dmdsec)
    - [5.3.4.	Use of the METS administrative metadata section (element amdSec)](metadata/#534-use-of-the-mets-administrative-metadata-section-element-amdsec)
    - [5.3.5.	Use of the METS file section (element fileSec)](metadata/#535-use-of-the-mets-file-section-element-filesec)
    - [5.3.6.	Use of the METS structural map (element structMap)](metadata/#536-use-of-the-mets-structural-map-element-structmap)
	- [5.4. Use of PREMIS](metadata/#54-use-of-premis/)

...
**Example:** METS root element example with content category not in the value list @TYPE being transferred
...
**Example:** METS root element example with transferred content of a category from the fixed value list and the representation content category is not part of the value list, but is instead a value decided upon in the submission agreement.

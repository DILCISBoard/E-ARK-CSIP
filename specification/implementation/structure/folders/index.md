...
The CSIP folder structure is presented in Figure 8 below. The structure directly follows the principles of the conceptual data model, dividing the package components into stand-alone folders for representations, metadata, and other components. All folders described here should be present even if they are empty.
